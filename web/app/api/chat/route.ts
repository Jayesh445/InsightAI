...
import z from "zod";
import { processImageWithGemini } from "@/ai/image";
import { pdfProcessingTool } from "@/ai/pdf"; // Import the new PDF processing tool
...
export async function POST(req: Request) {
  ...
  const result = streamText({
    ...
    tools: {
      ...
      // Add the new PDF processing tool
      pdf_processing: pdfProcessingTool,
    }
  });
